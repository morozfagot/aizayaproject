...
- **Путь:** `C:\Users\Евгений\Desktop\AIZaya\AiZayaProject`
- **Remote:** `origin` → `https://github.com/morozfagot/aizayaproject.git`
- **Ветка по умолчанию:** `developer`

## Правила

- Рабочая директория для ВСЕХ git-команд локального репозитория C:\Users\Евгений\Desktop\AIZaya\AiZayaProject: `AiZayaProject/`
